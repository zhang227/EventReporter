...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    //recycler view easy to divide zone and easy to add or edit
    ...
    public class EventViewHolder extends RecyclerView.ViewHolder {
        //find attribute in layout find id
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                      int viewType) {
        //will be called n times when you create n items
        //each item once
        //item not listView
    ...
    private void configureEventView(final EventViewHolder holder) {
        //render text view write in text view
    ...
    private void configureCommentView(final CommentViewHolder commentHolder, final int position) {
        //write the actual context to vie wholder
        //set text to it
        //Why is position - 1?
