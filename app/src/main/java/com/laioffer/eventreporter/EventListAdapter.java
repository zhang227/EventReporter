...
public class EventListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private LayoutInflater inflater;//transfrom regex to java object
    private DatabaseReference databaseReference;
    //map position and ads
    ...
    private void configureItemView(final ViewHolder holder, final int position) {
        ...
        //add dianzan when ever dianzan
        holder.good_number.setText(String.valueOf(event.getLike()));
        //add number to even list whenever add a comment
